<head>
  ...
  <script src="{{asset('template/js/printThis.js') }}"></script>
  <!-- Core plugin JavaScript-->
  <script src="{{asset('template/vendor/jquery-easing/jquery.easing.min.js') }}"></script>

  <script src="{{asset('template/js/fontawesome-iconpicker.js') }}"></script>
  <link href= "{{asset('template/css/fontawesome-iconpicker.min.css') }}" rel="stylesheet" type="text/css">
</head>
<body id="page-top">
